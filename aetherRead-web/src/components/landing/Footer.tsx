          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { label: 'Download for Android', href: '/projects/aetherRead/downloads/aetherRead-android.zip' },
                { label: 'Download for Windows', href: '/projects/aetherRead/downloads/aetherRead-windows.zip' },
